...
SELECT is( 
    ...
    '<gml:MultiSurface srsName="CRS:84"><gml:surfaceMember><gml:Polygon gml:id="polygon1"><gml:exterior><gml:LinearRing><gml:posList srsDimension="2">1 41 1 42 2 42 2 41 1 41</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon></gml:surfaceMember><gml:surfaceMember><gml:Polygon gml:id="polygon2"><gml:exterior><gml:LinearRing><gml:posList srsDimension="2">7 43 7 44 8 44 8 43 7 43</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon></gml:surfaceMember><gml:surfaceMember><gml:Polygon gml:id="polygon3"><gml:exterior><gml:LinearRing><gml:posList srsDimension="2">3 44 3 45 4 45 4 46 5 46 5 44 3 44</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon></gml:surfaceMember></gml:MultiSurface>',
...
SELECT is( 
    ...
    '<gml:Polygon gml:id="polygon1" srsName="CRS:84"><gml:exterior><gml:LinearRing><gml:posList srsDimension="2">0 40 0 50 10 50 10 40 0 40</gml:posList></gml:LinearRing></gml:exterior></gml:Polygon>',
