/* contrib/imos/imos--1.2--1.1.sql

   ## To manually downgrade from 1.2 to 1.1
...
\echo Use "ALTER EXTENSION imos UPDATE to 1.1 to load this file if on version 1.2." \quit
